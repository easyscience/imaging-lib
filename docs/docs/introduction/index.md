...
(GUI), please see the corresponding [GUI resources](https://easyscience.github.io/imaging-app).
...
<!--
**EasyImaging** is developed using the
[EasyScience framework](https://easyscience.org).
-->

## License

**EasyImaging** library is released under the
[BSD 3-Clause License](https://raw.githubusercontent.com/easyscience/imaging-lib/master/LICENSE).

## Releases

The latest version of the **EasyImaging** library is
[{{ vars.release_version }}](https://github.com/easyscience/imaging-lib/releases/latest).

For a complete list of new features, bug fixes, and improvements, see
the
[GitHub Releases page](https://github.com/easyscience/imaging-lib/releases).

## Citation

If you use **EasyImaging** library in your work,
please cite the specific version you used.

All official releases of the **EasyImaging** library are archived
...
**EasyImaging** is intended to be a community-driven, open-source
...
the [GitHub Issue Tracker](https://github.com/easyscience/imaging-lib/issues)
(A free GitHub account is required.)

To contribute code, documentation, or tests, please see our
[:material-account-plus: Contributing Guidelines](https://github.com/easyscience/imaging-lib/blob/master/CONTRIBUTING.md)
