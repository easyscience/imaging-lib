# Contributing to EasyImaging

Thank you for your interest in contributing to **EasyImaging**!
...
1. Open the repository page: `https://github.com/easyscience/imaging-lib`
...
3. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/<your-username>/imaging-lib.git
   cd imaging-lib
   ```
...
4. Add the original repository as `upstream`:
   ...
   ```bash
   git remote add upstream https://github.com/easyscience/imaging-lib.git
   ```
